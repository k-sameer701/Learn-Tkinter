...
button_equal = Button(root, text='=', padx=95, pady=18, command=button_equal)
button_clear = Button(root, text='Clear', padx=85, pady=18, command=button_clear)

button_subtract = Button(root, text='-', padx=40, pady=18, command=button_subtract)
button_multiply = Button(root, text='*', padx=40, pady=18, command=button_multiply)
button_divide = Button(root, text='/', padx=40, pady=18, command=button_divide)
